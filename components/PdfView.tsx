...
import { NamespaceSummaryFromJSON } from "@pinecone-database/pinecone/dist/pinecone-generated-ts-fetch/data";
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      <div className="sticky top-0 z-50 bg-gray-100 p-2 rounded-b-lg">
        <div className="mex-w-6xl px-2 grid grid-cols-6 gap-2">
          <Button
            variant="outline"
